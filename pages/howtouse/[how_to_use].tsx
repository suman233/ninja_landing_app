...
import { fetchSingleDetail } from "@/api/functions/cms.api";
...
const index = () => {
  ...
  const { data } = useQuery({
    queryKey: ["cmsdetails", { how_to_use }],
    queryFn: async () => {
      const resp = await axiosInstance.get<CMSDetailRoot>(
        endpoints.cms.detail(`${how_to_use}`)
      );
        ...
        <Container fixed>
          <TermsWrapper>
                  ...
                  <Box className="title_block">
                    ...
                    <Typography variant="h1" sx={{color:'white'}}>{data?.title}</Typography>
                  ...
                  <Box className="terms_content">
                    <Typography>
                      Effective date: Jan 1 2024 <br></br> The Abundant Kindness
                      Trust, located at 439 Westwood Shopping Center Suite 427
                      (“us”, “we”, or “our”) operates the
                      https://www.outdoors.ninja website (the “Service”).
                    </Typography>
                    ...
                    <p>
                      Information Collection And Use <br></br> We collect
                      several different types of information for various
                    ...
                    <p>
                      Tracking & Cookies Data <br></br> We use cookies and
                    ...
                    <p>
                      Use of Data
                      <br></br>
                      The Abundant Kindness Trust uses the collected data for
                      various purposes:
                      <br></br>
                    ...
                    <p>
                      The Abundant Kindness Trust may disclose your Personal
                    ...
                    <p>
                      ...
                      Google Analytics about visits activity. For more
                    ...
                    <p>
                      ...
                      your Children have provided us with Personal Data, please
                    ...
                    <p>
                      ...
                      effective when they are posted on this page. Contact Us
                      <br></br>
