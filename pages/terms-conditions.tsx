        ...
        <TermsWrapper>
          ...
          <Box className="terms_content">
            ...
            <ul>
              ...
              <li>
                <strong>Country</strong> refers to: North Carolina, United
                States
              </li>
              <li>
                <strong>Company</strong> (referred to as either “the Company”,
                “We”, “Us” or “Our” in this Agreement) refers to The Abundant
                Kindness Trust, LLC, 439 Westwood Shopping Center Suite 427
              ...
              <li>
                <strong>Website</strong> refers to Outdoors Ninja, accessible
                from www.outdoors.ninja
              </li>
              <li>
            ...
            <p>
              Our Service contains links to third-party web sites or services
              that are not owned or controlled by the Company. Many of these
              websites will require you to represent that you are over the age
              of 18. Many Companies that this application links you to does not
            ...
            <p>
              ...
              new terms, in whole or in part, please stop using the website and
              the Service.
            </p>
            <h3>Contact Us</h3>
            <p>
